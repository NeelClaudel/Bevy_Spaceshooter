...
use bevy_combat::player::PlayerPlugin;
use bevy_combat::player::ship_template::PlayerShipSpawner;
use rand::Rng;
...
fn setup(mut commands: Commands) {
    ...
    commands.spawn(SpawnBundle {
        spawn: PlayerShipSpawner,
        transform: Transform {
            translation: Vec3::ZERO,
            rotation: Quat::IDENTITY,
            scale: Vec3::splat(bevy_combat::player::constants::player_ship::PLAYER_SCALE),
        },
        team: Team(1),
    });
